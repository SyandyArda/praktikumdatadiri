...
// Definisikan warna-warna dari gambar (bisa disesuaikan)
val HeaderPurple = Color(0xFF9333EA) // Ungu cerah untuk header & tombol
val BackgroundLavender = Color(0xFFF3E8FF) // Latar belakang body yang sangat muda
val FormWhite = Color.White
val LabelGray = Color.Gray

@Composable
fun ActivitasPertama(modifier: Modifier = Modifier) {
    // 1. State variables untuk menyimpan input pengguna
        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(24.dp)) {
                    ...
                    // Field Jenis Kelamin (Radio Group)
                    FormRadioGroup(
                        label = "JENIS KELAMIN",
                    ...
                    // Field Status Perkawinan (Radio Group)
                    FormRadioGroup(
...
// Helper Composable untuk TextField (agar tidak berulang)
@Composable
fun FormTextField(
    label: String,
    value: String,
...
// Helper Composable untuk Radio Button Group (agar tidak berulang)
@Composable
fun FormRadioGroup(
    label: String,
    options: List<String>,
